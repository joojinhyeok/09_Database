...
// users 컬렉션에서 username이 jones인 문서를 찾아 출력
db.users.fint({username:"jones"})
...
* - 조건에 맞는 첫번째 문서를 삭제
* - deleteMany를 사용할때는 조건 없으면 전체가 삭제 되므로 주의 필요
